<?php /* Smarty version 3.1.32, created on 2019-02-13 16:17:55
         compiled from 'C:\xampp\htdocs\mylittleforum\lang\english.lang' */ ?>
<?php
/* Smarty version 3.1.32, created on 2019-02-13 16:17:55
  from 'C:\xampp\htdocs\mylittleforum\lang\english.lang' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5c644333b6d7a4_96283430',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b5cc0842660b1ba3816fa70e9052c1b36028db1d' => 
    array (
      0 => 'C:\\xampp\\htdocs\\mylittleforum\\lang\\english.lang',
      1 => 1550072547,
      2 => 'file',
    ),
  ),
...
function content_5c644333b6d7a4_96283430 (Smarty_Internal_Template $_smarty_tpl) {
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'browse_uploaded_images' => 'Browse uploaded images …',
        'back' => '&laquo; back',
    ...
    array (
      ...
      array (
        ...
        'b8_entry_check_enable' => 'enable B8',
        'b8_auto_training_enable' => 'Automated filter traning (Meaningfully, after sufficient manual training for spam and Ham entries!)',
        'b8_spam_probability_threshold' => 'Threshold to classify spam. Valid range is from 0&nsbp;% to 100&nsbp;%, e.g. a level of significance of 80&nbsp;% means, 20 of 100 entries are wrong classified by the filter as spam (false positive)',
        ...
        'update_instructions' => 
        array (
          0 => 'It is recommended to disable the forum while updating (uncheck "forum enabled" in the <a href="index.php?mode=admin&action=settings">forum settings</a>)',
          ...
          6 => 'Clear the directory <strong>templates_c</strong> (delete all files in this dirctory) after you have added/replaced the files/folders',
        ),
...
This e-mail has been sent via forum on [forum_address].',
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 'To install the forum please fill out and submit the following form.',
          1 => 'During the installation process the file <strong>config/db_settings.php</strong> will be overwritten. Depending on your server configuration you might have to change the write permission of this file (try CHMOD 666 if you get an error message; set it back to 644 after the installation).',
          2 => 'The directory <strong>templates_c</strong> needs to be writable by the template engine. Depending on your server configuration you might have to change the write permission of this directory (try CHMOD 770, 775 or 777 if you get an error message or blank page after the installation).',
          3 => 'Write permissions (CHMOD) of files and directories can normally be changed with the FTP program (right click on file/directory --> CHMOD or similar).',
          4 => 'The directory <strong>install</strong> can be deleted after the installation.',
        ),
